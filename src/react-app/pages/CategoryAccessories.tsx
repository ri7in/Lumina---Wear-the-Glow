...
const subcategories = ['Bags', 'Hats', 'Jewelry', 'Belts', 'Sunglasses'];
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const accessoriesProducts = data.filter((product: Product) => product.category === 'Accessories');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-source">Loading accessories collection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 font-source">
            Complete your look with our carefully curated accessories. From statement jewelry to 
            everyday essentials, find the perfect finishing touches for your personal style.
          </p>
