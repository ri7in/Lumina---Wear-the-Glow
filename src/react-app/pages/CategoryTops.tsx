...
const subcategories = ['Tees', 'Shirts', 'Crop Tops', 'Blouses', 'Tanks'];

export default function CategoryTops() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const topsProducts = data.filter((product: Product) => product.category === 'Tops');
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-source">Loading tops collection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 font-source">
            Essential pieces that form the foundation of your wardrobe. From casual tees to elegant blouses, 
            find your perfect fit for every occasion.
          </p>
