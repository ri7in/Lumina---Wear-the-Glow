...
const subcategories = ['Hoodies', 'Jackets', 'Cardigans', 'Blazers', 'Overshirts'];

export default function CategoryOuterwear() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const outerwearProducts = data.filter((product: Product) => product.category === 'Outerwear');
        setProducts(outerwearProducts);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-source">Loading outerwear collection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 font-source">
            Layer with intention. Our outerwear collection features timeless pieces that add 
            sophistication to any look while keeping you comfortable through every season.
          </p>
