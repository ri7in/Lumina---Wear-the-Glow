...
const subcategories = ['Jeans', 'Skirts', 'Shorts', 'Trousers', 'Cargo Pants'];

export default function CategoryBottoms() {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        ...
        const bottomsProducts = data.filter((product: Product) => product.category === 'Bottoms');
        setProducts(bottomsProducts);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-white">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-source">Loading bottoms collection...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto mb-8 font-source">
            From classic denim to flowing skirts, discover pieces that create beautiful silhouettes 
            and move with your lifestyle. Each piece is designed for comfort and confidence.
          </p>
